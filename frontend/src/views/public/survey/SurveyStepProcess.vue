<template>
  <div class="container" style="max-width:720px; padding-top:32px;">
    <SurveyProgressBar current-step="D" />
...
onMounted(async () => {
  ...
  try {
    const { data } = await publicApi.getSurveyItems(survey.responseId, 'D')
