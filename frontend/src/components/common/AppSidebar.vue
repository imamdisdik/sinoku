  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      <div class="nav-group">
        ...
        <router-link to="/admin" exact class="nav-item">&#9632; Dashboard</router-link>
      </div>
      ...
      <div class="nav-group">
        ...
        <router-link to="/admin/laporan-template" class="nav-item">&#128203; Laporan Template</router-link>
    ...
    <div class="sidebar-footer">
      <button @click="doLogout" class="logout-btn">&#128275; Keluar</button>
    </div>
  </aside>
</template>
...
.nav-item {
  ...
  color: rgba(255,255,255,0.75); text-decoration: none; font-size: 13px; transition: background 0.15s;
}
